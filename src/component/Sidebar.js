...
const Sidebar = () => {
    ...
    const togggleSide = (e) => {
        ...
        let sideItem = document.querySelector('.sideItem')
        let sideBar = document.querySelector('.sidebar')
        console.log(sideItem)
        sideItem.classList.toggle('Toggle')
        sideBar.classList.toggle('togglebtn')
        ...
        <div>
            ...
            <div className='sidebar'>
                <div className='togglebar'>
                    <i id='toggle-sidebar' onClick={() => togggleSide()}><GiHamburgerMenu /></i>
